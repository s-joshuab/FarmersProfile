          ...
          <div class="row justify-content-center">
            ...
            <span class="balaoann-text">Municipal Agri. Office</span>
              ...
              <div class="d-flex justify-content-center py-4">
                  ...
                  <form class="row g-3 needs-validation" action="auth/login.php"  method="post" novalidate>
                  ...
                  <?php } ?>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="password" name="pass" class="form-control" id="yourPassword" minlength="8" required>
