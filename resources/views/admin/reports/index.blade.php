...
<script>
    ...
    function hideFarmColumns() {
        $('#myTable tbody tr').each(function() {
            ...
            var showColumns = selectedCommodityIds.length === 0 || selectedCommodityIds.includes('all') || trCommodities.some(commodityId => selectedCommodityIds.includes(commodityId.toString()));
    ...
    $(document).ready(function() {
        ...
        // Initially hide farm_size and farm_location columns
        hideFarmColumns();
