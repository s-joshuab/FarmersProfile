                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-3">
                                            <select id="commoditiesFilter" class="form-select"
                                                aria-label="Commodities Filter">
                                                <option value="">All Commodities</option>
                                                @foreach ($commodities as $commodity)
                                                    <option value="{{ $commodity->id }}">{{ $commodity->commodities }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($farmers as $farmer)
                                            <tr data-barangay="{{ $farmer->barangay->id }}">
                                                ...
                                                <td data-barangay="{{ $farmer->barangay->id }}"
                                                    data-commodity="{{ $farmer->crops->pluck('commodity_id')->implode(',') }}">
                                                    @php
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <a href="{{ route('farmers.generate', ['id' => $farmer->id]) }}"
                                                            class="btn btn-sm btn-secondary generate-btn m-1">
                                                            <i class="bx bx-cog"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                ...
                                $(document).ready(function() {
                                    ...
                                    function filterTable(selectedBarangayId, selectedCommodityId) {
                                        ...
                                        if (selectedBarangayId === '' && selectedCommodityId === '') {
                                            ...
                                            $('#myTable tbody tr[data-barangay="' + selectedBarangayId + '"][data-commodity*="' +
                                                selectedCommodityId + '"]').show();
                                        }
                                    }
                                });
                            </script>
