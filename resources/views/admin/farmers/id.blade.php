                    ...
                    <div class="col-lg-12">
                        <div class="page mt-3 shadow-sm container"
                            ...
                            <div class="content" style="position: relative;">
                                ...
                                <p style="font-size: 12px; font-weight: bold; margin-left: 140px; margin-top: -2px;">
                                    ID Number:<br> {{ $farmers->farmersNumbers->first()->farmersnumber }}</p>
                                <p style="font-size: 12px; font-weight: bold; margin-left: 230px; margin-top: -52px;">
                                    Sex:<br> {{ $farmers->sex }} </p>
                                <div class="row">
                                    <p style="font-size: 10px; font-weight: bold; margin-left: 33px; margin-top: 15px;">
                                        Signature</p>
                                    <p style="font-size: 12px; font-weight: bold; margin-left: 140px; margin-top: -52px;">
                                        Contact No:<br> {{ $farmers->number }} </p>

                                    <p style="font-size: 12px; font-weight: bold; margin-top: -53px; margin-left: 230px;">
