                            ...
                            <div class="col-md-6 position-relative mt-5">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="col-md-4 position-relative mt-0">
                                            <label for="selectedProvince">Selected Province:</label>
                                            <div id="selectedProvince" class="form-control" readonly></div>
                                        </div>

                                        <div class="col-md-4 position-relative mt-0">
                                            <label for="selectedMunicipality">Selected Municipality:</label>
                                            <div id="selectedMunicipality" class="form-control" readonly></div>
                                        </div>


                                        <div class="col-md-4 position-relative mt-2">
                                            <label for="selectedBarangay">Selected Barangay:</label>
                                            <div id="selectedBarangay" class="form-control" readonly></div>
                                        </div>
