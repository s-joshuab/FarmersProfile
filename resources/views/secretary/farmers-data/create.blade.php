                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <script>
                                            ...
                                            function getMunicipality(province_id) {
                                                $.ajax({
                                                    url: '/get-municipality/' + province_id,
                                                    type: 'GET',
                                                    dataType: 'json',
                                            ...
                                            function getBarangay(municipality_id) {
                                                $.ajax({
                                                    url: '/get-barangay/' + municipality_id,
                                                    type: 'GET',
                                                    dataType: 'json',
                                                    success: function(response) {
                                                        // Clear previous options
